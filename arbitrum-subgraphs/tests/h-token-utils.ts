...
import {
  ...
  InterestAccrued,
  LiquidationClosed,
  ProtocolCommissionsWithdrawn,
  ProtocolFeesUpdated,
  Redeem,
  RepayBorrow,
  ReservesAdded,
  ReservesReduced,
  HTokenRoleAdminChanged,
  HTokenRoleGranted,
  HTokenRoleRevoked,
  TransferBatch,
  TransferSingle,
...
export function createAdminCommissionsWithdrawnEvent(
  _amount: BigInt
): AdminCommissionsWithdrawn {
  let adminCommissionsWithdrawnEvent = changetype<AdminCommissionsWithdrawn>(
    newMockEvent()
  )

  adminCommissionsWithdrawnEvent.parameters = new Array()

  adminCommissionsWithdrawnEvent.parameters.push(
    new ethereum.EventParam(
      "_amount",
  ...
  return adminCommissionsWithdrawnEvent
}
...
export function createProtocolCommissionsWithdrawnEvent(
  _amount: BigInt
): ProtocolCommissionsWithdrawn {
  let protocolCommissionsWithdrawnEvent = changetype<
    ProtocolCommissionsWithdrawn
  >(newMockEvent())

  protocolCommissionsWithdrawnEvent.parameters = new Array()

  protocolCommissionsWithdrawnEvent.parameters.push(
    new ethereum.EventParam(
      "_amount",
      ethereum.Value.fromUnsignedBigInt(_amount)
    )
  ...
  return protocolCommissionsWithdrawnEvent
}

export function createProtocolFeesUpdatedEvent(
  _oldProtocolCommission: BigInt,
  _newProtocolCommission: BigInt,
  _oldAdminCommission: BigInt,
  _newAdminCommission: BigInt,
  ...
  protocolFeesUpdatedEvent.parameters.push(
    new ethereum.EventParam(
      "_oldProtocolCommission",
      ethereum.Value.fromUnsignedBigInt(_oldProtocolCommission)
    )
  )
  protocolFeesUpdatedEvent.parameters.push(
    new ethereum.EventParam(
      "_newProtocolCommission",
      ethereum.Value.fromUnsignedBigInt(_newProtocolCommission)
    )
  )
  protocolFeesUpdatedEvent.parameters.push(
    new ethereum.EventParam(
      "_oldAdminCommission",
      ethereum.Value.fromUnsignedBigInt(_oldAdminCommission)
    )
  )
  protocolFeesUpdatedEvent.parameters.push(
    new ethereum.EventParam(
      "_newAdminCommission",
      ethereum.Value.fromUnsignedBigInt(_newAdminCommission)
    )
  )
  protocolFeesUpdatedEvent.parameters.push(
    new ethereum.EventParam(
...
export function createHTokenRoleAdminChangedEvent(
  role: Bytes,
  previousAdminRole: Bytes,
  newAdminRole: Bytes
): HTokenRoleAdminChanged {
  let hTokenRoleAdminChangedEvent = changetype<HTokenRoleAdminChanged>(
    newMockEvent()
  )

  hTokenRoleAdminChangedEvent.parameters = new Array()

  hTokenRoleAdminChangedEvent.parameters.push(
  ...
  return hTokenRoleAdminChangedEvent
}

export function createHTokenRoleGrantedEvent(
  role: Bytes,
  account: Address,
  sender: Address
): HTokenRoleGranted {
  let hTokenRoleGrantedEvent = changetype<HTokenRoleGranted>(newMockEvent())

  hTokenRoleGrantedEvent.parameters = new Array()

  hTokenRoleGrantedEvent.parameters.push(
    new ethereum.EventParam("role", ethereum.Value.fromFixedBytes(role))
  )
  hTokenRoleGrantedEvent.parameters.push(
    new ethereum.EventParam("account", ethereum.Value.fromAddress(account))
  ...
  return hTokenRoleGrantedEvent
}

export function createHTokenRoleRevokedEvent(
  role: Bytes,
  account: Address,
  sender: Address
): HTokenRoleRevoked {
  let hTokenRoleRevokedEvent = changetype<HTokenRoleRevoked>(newMockEvent())

  hTokenRoleRevokedEvent.parameters = new Array()

  hTokenRoleRevokedEvent.parameters.push(
    new ethereum.EventParam("role", ethereum.Value.fromFixedBytes(role))
  )
  hTokenRoleRevokedEvent.parameters.push(
    new ethereum.EventParam("account", ethereum.Value.fromAddress(account))
