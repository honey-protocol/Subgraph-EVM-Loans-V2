...
export class Hivemind__getBorrowFeePerMarketResult {
  value0: BigInt;
  value1: boolean;
...
export class Hivemind__getHypotheticalAccountLiquidityResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Hivemind__getMarketDataResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class Hivemind__marketPausedInfoResult {
  value0: boolean;
  value1: boolean;
  value2: boolean;
  value3: boolean;
...
export class Hivemind extends ethereum.SmartContract {
  static bind(address: Address): Hivemind {
    return new Hivemind("Hivemind", address);
  }
  ...
  FEE_CAP(): BigInt {
    let result = super.call("FEE_CAP", "FEE_CAP():(uint256)", []);

    return result[0].toBigInt();
  }

  try_FEE_CAP(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("FEE_CAP", "FEE_CAP():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  getBorrowFeePerMarket(
    ...
    _referral: string,
    _signature: Bytes
  ): Hivemind__getBorrowFeePerMarketResult {
    let result = super.call(
      "getBorrowFeePerMarket",
    ...
    return new Hivemind__getBorrowFeePerMarketResult(
      result[0].toBigInt(),
      result[1].toBoolean()
    );
  }
  ...
  try_getBorrowFeePerMarket(
    ...
    _referral: string,
    _signature: Bytes
  ): ethereum.CallResult<Hivemind__getBorrowFeePerMarketResult> {
    let result = super.tryCall(
      "getBorrowFeePerMarket",
      "getBorrowFeePerMarket(address,string,bytes):(uint256,bool)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Hivemind__getBorrowFeePerMarketResult(
        value[0].toBigInt(),
        value[1].toBoolean()
      )
    );
  ...
  getCollateralFactor(_hToken: Address): BigInt {
    let result = super.call(
      "getCollateralFactor",
      "getCollateralFactor(address):(uint256)",
      [ethereum.Value.fromAddress(_hToken)]
    );
  ...
  try_getCollateralFactor(_hToken: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getCollateralFactor",
      "getCollateralFactor(address):(uint256)",
      [ethereum.Value.fromAddress(_hToken)]
  ...
  getHypotheticalAccountLiquidity(
  ...
  ): Hivemind__getHypotheticalAccountLiquidityResult {
    let result = super.call(
      "getHypotheticalAccountLiquidity",
    ...
    return new Hivemind__getHypotheticalAccountLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getHypotheticalAccountLiquidity(
    ...
    _redeemTokens: BigInt,
    _borrowAmount: BigInt
  ): ethereum.CallResult<Hivemind__getHypotheticalAccountLiquidityResult> {
    let result = super.tryCall(
      "getHypotheticalAccountLiquidity",
      "getHypotheticalAccountLiquidity(address,address,uint256,uint256,uint256):(uint256,uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Hivemind__getHypotheticalAccountLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  getMarketData(_hToken: Address): Hivemind__getMarketDataResult {
    let result = super.call(
      "getMarketData",
    ...
    return new Hivemind__getMarketDataResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getMarketData(
    _hToken: Address
  ): ethereum.CallResult<Hivemind__getMarketDataResult> {
    let result = super.tryCall(
      "getMarketData",
      "getMarketData(address):(bool,uint256,uint256)",
      [ethereum.Value.fromAddress(_hToken)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Hivemind__getMarketDataResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  marketPausedInfo(param0: Address): Hivemind__marketPausedInfoResult {
    let result = super.call(
      "marketPausedInfo",
    ...
    return new Hivemind__marketPausedInfoResult(
      result[0].toBoolean(),
      result[1].toBoolean(),
      result[2].toBoolean(),
      result[3].toBoolean(),
  ...
  try_marketPausedInfo(
    param0: Address
  ): ethereum.CallResult<Hivemind__marketPausedInfoResult> {
    let result = super.tryCall(
      "marketPausedInfo",
      "marketPausedInfo(address):(bool,bool,bool,bool,bool,bool,bool)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Hivemind__marketPausedInfoResult(
        value[0].toBoolean(),
        value[1].toBoolean(),
        value[2].toBoolean(),
        value[3].toBoolean(),
...
export class DepositAllowedCall extends ethereum.Call {
  get inputs(): DepositAllowedCall__Inputs {
    return new DepositAllowedCall__Inputs(this);
  }

  get outputs(): DepositAllowedCall__Outputs {
    return new DepositAllowedCall__Outputs(this);
  }
}

export class DepositAllowedCall__Inputs {
  _call: DepositAllowedCall;

  constructor(call: DepositAllowedCall) {
    this._call = call;
  }
...
export class DepositAllowedCall__Outputs {
  _call: DepositAllowedCall;
